...
void TestLoad() {
	...
	std::uniform_int_distribution<size_t> line_len_gen(50, 50); //max 1000 words in 1 doc
	...
	for (int line = 0; line < 50000; ++line) { //500000 queries max
		ostringstream line_out;
	...
	SearchServer* srv = nullptr;
	{
		LOG_DURATION("Upd");
		srv = new SearchServer(docs_input);
	}
